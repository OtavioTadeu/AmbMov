...
// =============================================================================
// MODEL — Classe Personagem com fromJson
// =============================================================================
class Personagem {
  final int id;
  final String nome;
  ...
  factory Personagem.fromJson(Map<String, dynamic> json) {
    return Personagem(
      ...
      origem: json['origin'] != null
          ? (json['origin']['name'] ?? 'Desconhecido')
          : 'Desconhecido',
    );
  }
}
...
// =============================================================================
// TELA LISTA — Listagem dos personagens
// =============================================================================
...
// =============================================================================
// TELA DETALHE — Detalhes do personagem
// =============================================================================
